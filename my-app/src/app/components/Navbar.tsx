  ...
  return (
    <div className="absolute w-[78vw] mx-[10.5vw] max-xl:w-[90vw] max-xl:mx-[4vw] ">
      <div className="flex justify-between mt-6 ">
        ...
        <div
        data-aos="zoom-in"
          className={`font-[600] tracking-[1px] ${poppins.className} transition-all flex flex-col text-sm  text-[#17abff] border-2 border-[#17abff] px-12 rounded-lg uppercase justify-center max-sm:hidden hover:bg-[#17abff] cursor-pointer hover:text-[#fcfcfc] `}
        >
          Enquire Now
        </div>
